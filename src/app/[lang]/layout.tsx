...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      ...
      <body className={clsx(inter.className, `dark:bg-slate-950`)}>
        <div className="dark:bg-slate-950 bg-white dark:text-white flex flex-col justify-center md:flex-row min-h-screen overflow-auto px-6 py-8 md:px-0 md:py-24 gap-4 md:gap-0 max-w-screen-lg mx-auto relative">
